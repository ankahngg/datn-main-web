...
export const mockAuctionTransactionsResponse: Page<AuctionTransactionResponse> = {
    content: [
        {   
            ...
            bidAmount: BigInt(1000000000), // 1000 USDC
        ...
        {   
            ...
            auctionId: BigInt(1001),
            auctionAction: "BID",
            bidder: "0xdF3e18d64BC6A983f673Ab319CCaE4f1a57C7097",
            bidAmount: BigInt(1200000000), // 1200 USDC
            endTime: "2026-06-16T10:00:00Z",
            txHash: "0xabc123...def456",
            logIndex: 0,
            blockNumber: 12345678,
        ...
        {   
            ...
            auctionAction: "BID",
            bidder: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266",
            bidAmount: BigInt(1500000000), // 1500 USDC
            endTime: "2026-06-16T10:00:00Z",
            txHash: "0xabc123...def456",
            logIndex: 0,
            blockNumber: 12345678,
            eventTimestamp: "2026-06-09T13:00:00Z",
